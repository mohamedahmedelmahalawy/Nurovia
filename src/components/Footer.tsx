...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10 mt-20">
      <svg
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          <img
            src={assets.logo}
            alt="Nurovia Logo"
            className="w-44 h-auto filter hover:grayscale transition duration-300"
          />
          <p className="text-sm/7 mt-6">
            Experience the power of AI with Nurovia.
            <br />
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            ...
            <div className="flex items-center">
              ...
              />
              <button className="bg-primary hover:bg-indigo-900 transition px-4 h-11 text-white rounded-r-md cursor-pointer">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200 text-center">
        <p className="text-center">
          Copyright 2026 © <a href="https://Nurovia.com">Nurovia</a> All Right
          Reserved.
        </p>
