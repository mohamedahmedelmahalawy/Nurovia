...
export default function Hero() {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative flex flex-col items-center justify-center w-full min-h-screen bg-[url('./src/assets/gradientBackground.png')] bg-cover bg-no-repeat">
      <div className="text-center mb-6">
        <h1 className="text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]">
          Create amazing content <br />{" "}
          <span className="text-primary">with AI tools</span>
        </h1>
        <p className="mt-4 max-w-xs sm:max-w-lg m-auto max-sm:text-xs text-gray-600">
